...
('M03', 'Moto G Play 7ma Gen', 'Ya siete de estos?', 1, 1, 'https://www.motorola.cl/arquivos/moto-g7-play-img-product.png?v=636862863804700000', 15699),
...
select a.Id, a.Codigo, a.Nombre, a.Descripcion, IdMarca, m.Descripcion, IdCategoria, c.Descripcion, a.ImagenUrl, a.Precio from ARTICULOS a left join MARCAS m on a.IdMarca = m.Id left join CATEGORIAS c on a.IdCategoria = c.Id
